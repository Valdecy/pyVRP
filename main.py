...
fleet_size    = [1  ,  4]  # An Empty List, e.g  fleet_size = [ ], means that the Fleet is Infinite. Non-Empty List, e.g  fleet_size = [15, 7], means that there are available 15 vehicles of type A and 7 vehicles of type B
